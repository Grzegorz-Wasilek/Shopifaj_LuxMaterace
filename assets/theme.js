...
import { animate, timeline as timeline2, stagger } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { stagger as stagger2 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { animate as animate2, stagger as stagger3, inView } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { inView as inView2 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { timeline as timeline3, inView as inView3 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { animate as animate3 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { animate as animate4 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { Delegate as Delegate2 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { animate as animate5 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { Delegate as Delegate3 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
onVariantChanged_fn2 = function(event) {
  ...
  if (variant["compare_at_price"] > variant["price"]) {
    this.hidden = false; // Zawsze pokazuj komponent, jeśli jest promocja
    this.innerHTML = `Najniższa cena z ostatnich 30 dni`; // Ustaw stały tekst
  } else {
    this.hidden = true; // Ukryj, jeśli nie ma promocji
  }
};
...
import { PhotoSwipeLightbox } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//431ee1.myshopify.com/cdn/shop/t/30/assets/photoswipe.min.js?v=20290624223189769891709920957"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { inView as inView4 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
    ...
    if (this.hasAttribute("show-play-button") && !this.shadowRoot) {
      this.attachShadow({ mode: "open" }).appendChild(document.createRange().createContextualFragment(`
        ...
        <svg part="play-button" fill="none" width="48" height="48" viewBox="0 0 48 48">
          ...
          <path d="M18.578 32.629a.375.375 0 0 1-.578-.316V15.687c0-.297.328-.476.578-.316l12.931 8.314c.23.147.23.483 0 .63L18.578 32.63Z" fill="#022e4f"/>
          <path d="M24 .5C36.979.5 47.5 11.021 47.5 24S36.979 47.5 24 47.5.5 36.979.5 24 11.021.5 24 .5Z" stroke="#022e4f" stroke-opacity=".12"/>
        </svg>
      `));
    }
  }
...
import { timeline as timeline6 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { animate as animate8 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { animate as animate9 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
import { animate as animate10, inView as inView5 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
...
// js/theme.js
import { Delegate as Delegate4 } from "//431ee1.myshopify.com/cdn/shop/t/30/assets/vendor.min.js?v=52426788336887041471709920957";
(() => {
...
//-galeria zdjenc 2 zdjecie pierwsze--//
